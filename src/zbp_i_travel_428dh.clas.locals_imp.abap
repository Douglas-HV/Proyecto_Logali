CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS validadataAgency FOR VALIDATE ON SAVE
      IMPORTING keys FOR Travel~validadataAgency.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_features.
    ...
    READ ENTITIES OF zi_travel_428dh IN LOCAL MODE
        ENTITY travel
  ...
  METHOD setTravelNumber.
    ...
    SELECT SINGLE FROM ztravel_428dh FIELDS MAX( travel_id ) INTO @DATA(max_travelid).

    MODIFY ENTITIES OF zi_travel_428dh IN LOCAL MODE
      ENTITY travel
