CLASS zcl_insert_data_dh DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_dh IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    data: lt_acc_categ type table of ztb_acc_categ_dh,
          lt_catego    type table of ztb_catego_dh,
          lt_clientes  type table of ztb_clientes_dh,
          lt_clnts_lib type table of ztb_clnts_lib_dh,
          lt_libros    type table of ztb_libros_dh.
...
******** ztb_acc_categ_dh ********
    ...
    delete from ztb_acc_categ_dh.
    insert ztb_acc_categ_dh from table @lt_acc_categ.
...
******** ztb_catego_dh ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_dh.
    insert ztb_catego_dh from table @lt_catego.
...
******** ztb_clientes_dh ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_dh.
    insert ztb_clientes_dh from table @lt_clientes.
...
******** ztb_clnts_lib_dh
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_dh.
    insert ztb_clnts_lib_dh from table @lt_clnts_lib.
...
******** ztb_libros_dh ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_dh.
    insert ztb_libros_dh from table @lt_libros.
